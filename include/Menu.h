...
#include "Game.h" // Inclui Game.h para ter acesso a GameState, Player, Music, GameModeType, etc.
#include <stdbool.h>

extern bool g_request_exit;

typedef enum { BUTTON_ACTION_NONE, BUTTON_ACTION_GOTO_PLAYER_MODE_MENU, BUTTON_ACTION_NEW_GAME_SETUP_SLOT, BUTTON_ACTION_SETTINGS, BUTTON_ACTION_QUIT_GAME, BUTTON_ACTION_RESUME_GAME, BUTTON_ACTION_SAVE_GAME, BUTTON_ACTION_LOAD_GAME, BUTTON_ACTION_PAUSE_SETTINGS, BUTTON_ACTION_GOTO_MAIN_MENU, BUTTON_ACTION_GOTO_SINGLE_PLAYER_SETUP, BUTTON_ACTION_GOTO_TWO_PLAYER_SETUP } MenuButtonAction;
typedef struct { Rectangle rect; const char *text; Color base_color; Color hover_color; Color disabled_color; Color text_color; bool is_active; bool is_hovered; MenuButtonAction action; } MenuButton;
...
bool Menu_IsInSaveMode(void); bool Menu_IsNewGameFlow(void);
int Menu_GetSaveLoadSubState(void); int Menu_GetSelectedSlotForAction(void);
