...
typedef enum { GAMESTATE_MENU, GAMESTATE_INTRO, GAMESTATE_PLAYER_MODE_MENU, GAMESTATE_CHARACTER_CREATION, GAMESTATE_PLAYING, GAMESTATE_PAUSE, GAMESTATE_INVENTORY, GAMESTATE_SAVE_LOAD_MENU, GAMESTATE_SETTINGS } GameState;
